...
<div id="header">
	...
	<div id="menu">
		<ul>
			<li class="active"><a href="plogin.php" title="">Home</a></li>
		...
		<div id="login" class="boxed">
			...
			<div class="content">
				...
				<ul>
					...
					<li><a href="pacademic.php" title="">Academic Records</a></li>
		...
		<div id="welcome" class="post">
			...
			<div id="login" class="story">
				...
				<select name="sems" size="1">
					<option value="1">Select Type of Information:</option>
					<option value="2">Personal Information</option>
					<option value="3">Family Background</option>
					<option value="4">Special Intrests</option>
					<option value="5">About Me</option>
				</select>
				<a href="pkinfo.php"><input id="inputsubmit1" type="button" value="Next"/></a>
				</form>
			</div>
			<div class="meta">
