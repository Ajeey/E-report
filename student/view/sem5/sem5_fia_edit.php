		...
		<div id="welcome" class="post">
			...
			<div id="login" align="center" class="story">
					<form id="sem5_fia" class="formular" method="post" action="sem5_fia_process.php">
						...
						<table border="1" bordercolor="#4c84f7" width="80%" cellspacing="2" cellpadding="3">
							...
							<tr>
									...
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca51_fia" id="10mca51_fia" class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $a1?>"/>
										</div>
									</th>
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca52_fia" id="10mca52_fia" class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $a2?>"/>
									</div>
									</th>
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca53_fia" id="10mca53_fia" class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $a3?>"/>
									</div>
									</th>
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca541_fia" id="10mca541_fia"  value="<?php echo $a4?>"/>
									</div>
									</th>
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca542_fia" id="10mca542_fia"  value="<?php echo $a5?>"/>
									</div>
									</th>
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca543_fia" id="10mca543_fia"  value="<?php echo $a6?>"/>
									</div>
									</th>
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca544_fia" id="10mca544_fia"  value="<?php echo $a7?>"/>
									</div>
									</th>
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca545_fia" id="10mca545_fia"  value="<?php echo $a8?>"/>
									</div>
									</th>
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca546_fia" id="10mca546_fia"  value="<?php echo $a9?>"/>
									</div>
									</th>
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca551_fia" id="10mca551_fia"  value="<?php echo $a10?>"/>
									</div>
									</th>
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca552_fia" id="10mca552_fia"  value="<?php echo $a11?>"/>
									</div>
									</th>
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca553_fia" id="10mca553_fia"  value="<?php echo $a12?>"/>
									</div>
									</th>
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca554_fia" id="10mca554_fia"  value="<?php echo $a13?>"/>
									</div>
									</th>
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca555_fia" id="10mca555_fia"  value="<?php echo $a14?>"/>
									</div>
									</th>
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca556_fia" id="10mca556_fia"  value="<?php echo $a15?>"/>
									</div>
									</th>
							</tr>
							<tr>
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca56_fia" id="10mca56_fia"class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $a16?>"/>
									</div>
									</th>
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca57_fia" id="10mca57_fia"class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $a17?>"/>
									</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca58_fia" id="10mca58_fia"class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $a18?>"/>
									</div>
									</th>
						...
						<a href="sem5_fia.php"><input id="inputsubmit1" type="button" name="inputsubmit1" value="   Back   " /></a>
					</form>
