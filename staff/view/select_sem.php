...
<div id="content">
		...
		<div id="login" class="boxed">
			...
			<div class="content">
				<form id="form1" method="post" action="#">
					...
					<a href="../view/select_usn.php"><input id="inputsubmit1" type="button" name="inputsubmit1" value="  Back  "/></a>&nbsp;&nbsp;&nbsp;
	...
	<div id="main">
		<div id="welcome" class="post">
			...
			<form name="" action="call_view_form.php" method="post">
				
				<h2>SEMESTER</h2>
				<select name="v_sems" size="1">
