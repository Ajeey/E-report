	...
	<div id="main1">
		<div id="welcome" class="post">
			...
			<div id="login" align="center" class="story">
					<form id="sem1_ia1" class="formular" method="post" action="add_remarks_ia1.php">
						...
						<tr>
								<th width="364" scope="col">
									<div align="left">
									<textarea name="remarks_ia1" id="remarks_ia1" cols="80" rows="5"></textarea>
									</div>
								</th>
						</tr>
						</table></br>
						
						<input id="inputsubmit1" type="submit" name="inputsubmit1" value="  Add Remarks   " />&nbsp;&nbsp;&nbsp;
