	...
	<div id="main1">
		<div id="welcome" class="post">
			...
			<div id="login" align="center" class="story">
					<form  id="sem1_ia2" class="formular" method="post" action="mail_ia2.php">
						...
						<input id="inputsubmit1" type="submit" name="inputsubmit1" value="  Send mail  " />&nbsp;&nbsp;&nbsp;
