					...
					<form id="sem1_ee" class="formular" method="post" action="sem1_ee_process.php">
						...
						<table border="1" bordercolor="#4c84f7" width="80%" cellspacing="2" cellpadding="3">
							...
							<tr>
									...
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca11_ee" id="10mca11_ee"  disabled="disabled" value="<?php echo $a1?>"/>
										</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca11_pf" id="mname"  disabled="disabled" value="<?php echo $p1?>"/>
										</div>
									</th>
									<th width="364" scope="col" rowspan="8"><?php echo $r1?>
										<!-- <div align="center"><textarea name="class_obtained" id="class_obtained" cols="10" rows="15"  disabled="disabled" value="<?php echo $r1?>"></textarea>--> 
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca12_ee" id="10mca12_ee"  disabled="disabled" value="<?php echo $a2?>"/>
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca12_pf" id="mname"  disabled="disabled" value="<?php echo $p2?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca13_ee" id="10mca13_ee"  disabled="disabled" value="<?php echo $a3?>"/>
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca13_pf" id="mname"  disabled="disabled" value="<?php echo $p3?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca14_ee" id="10mca14_ee"  disabled="disabled" value="<?php echo $a4?>"/>
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca14_pf" id="mname"  disabled="disabled" value="<?php echo $p4?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca15_ee" id="10mca15_ee"  disabled="disabled" value="<?php echo $a5?>"/>
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca15_pf" id="mname"  disabled="disabled" value="<?php echo $p5?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca16_ee" id="10mca16_ee"  disabled="disabled" value="<?php echo $a6?>"/>
										</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca16_pf" id="mname"  disabled="disabled" value="<?php echo $p6?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca17_ee" id="10mca17_ee"  disabled="disabled" value="<?php echo $a7?>"/>
										</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca17_pf" id="mname"  disabled="disabled" value="<?php echo $p7?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca18_ee" id="10mca18_ee"  disabled="disabled" value="<?php echo $a8?>"/>
										</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca18_pf" id="mname"  disabled="disabled" value="<?php echo $p8?>"/>
										</div>
									</th>
							</tr>
						</table>
						...
						<tr>
								<th width="364" scope="col">
									...
									<!--  <textarea name="goals" id="goals" cols="83" rows="5" disabled="disabled" value="<?php echo $r2?>"></textarea>-->
									</div>
								</th>
						</tr>
						</table>
						<pre>
							...
							<a href="sem1_ee_edit.php"><input id="inputsubmit1" type="button" name="inputsubmit1" value="   Edit   " /></a>&nbsp;&nbsp;&nbsp;				
					</form>
