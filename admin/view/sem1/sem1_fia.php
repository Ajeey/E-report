			...
			<div id="login" align="center" class="story">
					<form id="sem1_fia" class="formular" method="post" action="sem1_fia_process.php">
						...
						<table border="1" bordercolor="#4c84f7" width="80%" cellspacing="2" cellpadding="3">
							...
							<tr>
									...
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca11_fia" id="10mca11_fia"  disabled="disabled" value="<?php echo $a1?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca12_fia" id="10mca12_fia"  disabled="disabled" value="<?php echo $a2?>"/>
									</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca13_fia" id="10mca13_fia"  disabled="disabled" value="<?php echo $a3?>"/>
									</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca14_fia" id="10mca14_fia"  disabled="disabled" value="<?php echo $a4?>"/>
									</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca15_fia" id="10mca15_fia"  disabled="disabled" value="<?php echo $a5?>"/>
									</div>
									</th>
							</tr>
							<tr>
									...
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca16_fia" id="10mca16_fia"  disabled="disabled" value="<?php echo $a6?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca17_fia" id="10mca17_fia"  disabled="disabled" value="<?php echo $a7?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca18_fia" id="10mca18_fia"  disabled="disabled" value="<?php echo $a8?>"/>
										</div>
									</th>
							</tr>
						</table>
						<pre>
								...
								<a href="sem1_fia_edit.php"><input id="inputsubmit1" type="button" name="inputsubmit1" value="   Edit   " /></a>&nbsp;&nbsp;&nbsp;					
					</form>
