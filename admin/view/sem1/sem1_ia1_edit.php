	...
	<div id="main1">
		<div id="welcome" class="post">
			...
			<div id="login" align="center" class="story">
					<form id="sem1_ia1" class="formular" method="post" action="sem1_ia1_process.php">
						...
						<table border="1" bordercolor="#4c84f7" width="80%" cellspacing="2" cellpadding="3">
							...
							<tr>
									...
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca11_ia1" id="10mca11_ia1"  value="<?php echo $a1?>" />
										</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca11_atd" id="10mca11_atd"  value="<?php echo $a6?>" />
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca12_ia1" id="10mca12_ia1" value="<?php echo $a2?>" />
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca12_atd" id="10mca12_atd" value="<?php echo $a7?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca13_ia1" id="10mca13_ia1"  value="<?php echo $a3?>"/>
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca13_atd" id="10mca13_atd"   value="<?php echo $a8?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca14_ia1" id="10mca14_ia1"   value="<?php echo $a4?>"/>
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca14_atd" id="10mca14_atd" value="<?php echo $a9?>" />
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca15_ia1" id="10mca15_ia1"   value="<?php echo $a5?>"/>
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca15_atd" id="10mca15_atd"  value="<?php echo $a10?>"/>
										</div>
									</th>
							</tr>
						</table>
						...
						<a href="sem1_ia1.php"><input id="inputsubmit1" type="button" name="inputsubmit1" value="   Back   " /></a>
