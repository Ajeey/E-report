			...
			<div id="login" align="center" class="story">
					<form id="sem2_ia3" class="formular" method="post" action="sem2_ia3_process.php">
						...
						<table border="1" bordercolor="#4c84f7" width="80%" cellspacing="2" cellpadding="3">
							...
							<tr>
									...
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca21_ia3" id="10mca21_ia3" disabled="disabled" value="<?php echo $a1?>" />
										</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca21_atd" id="10mca21_atd" disabled="disabled" value="<?php echo $a6?>" />
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca22_ia3" id="10mca22_ia3" disabled="disabled" value="<?php echo $a2?>" />
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca22_atd" id="10mca22_atd" disabled="disabled" value="<?php echo $a7?>" />
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca23_ia3" id="10mca23_ia3" disabled="disabled" value="<?php echo $a3?>" />
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca23_atd" id="10mca23_atd" disabled="disabled" value="<?php echo $a8?>" />
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca24_ia3" id="10mca24_ia3" disabled="disabled" value="<?php echo $a4?>" />
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca24_atd" id="10mca24_atd" disabled="disabled" value="<?php echo $a9?>" />
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca25_ia3" id="10mca25_ia3" disabled="disabled" value="<?php echo $a5?>" />
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca25_atd" id="10mca25_atd" disabled="disabled" value="<?php echo $a10?>" />
										</div>
									</th>
							</tr>
						</table>
						<pre>
							...
							<a href="sem2_ia3_edit.php"><input id="inputsubmit1" type="button" name="inputsubmit1" value="   Edit   " /></a>&nbsp;&nbsp;&nbsp;
					</form>
