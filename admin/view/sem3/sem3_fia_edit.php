		...
		<div id="welcome" class="post">
			...
			<div id="login" align="center" class="story">
					<form id="sem3_fia" class="formular" method="post" action="sem3_fia_process.php">
						...
						<table border="1" bordercolor="#4c84f7" width="80%" cellspacing="2" cellpadding="3">
							...
							<tr>
									...
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca31_fia" id="10mca31_fia"  value="<?php echo $a1?>" class="validate[required] text-input" data-prompt-position="topLeft:-50"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca32_fia" id="10mca32_fia"  value="<?php echo $a2?>"class="validate[required] text-input" data-prompt-position="topLeft:-50"/>
									</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca33_fia" id="10mca33_fia"  value="<?php echo $a3?>"class="validate[required] text-input" data-prompt-position="topLeft:-50"/>
									</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca34_fia" id="10mca34_fia"  value="<?php echo $a4?>"class="validate[required] text-input" data-prompt-position="topLeft:-50"/>
									</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca35_fia" id="10mca35_fia"  value="<?php echo $a5?>"class="validate[required] text-input" data-prompt-position="topLeft:-50"/>
									</div>
									</th>
							</tr>
							<tr>
									...
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca36_fia" id="10mca36_fia"  value="<?php echo $a6?>"class="validate[required] text-input" data-prompt-position="topLeft:-50"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca37_fia" id="10mca37_fia" value="<?php echo $a7?>"class="validate[required] text-input" data-prompt-position="topLeft:-50"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca38_fia" id="10mca38_fia"  value="<?php echo $a8?>"class="validate[required] text-input" data-prompt-position="topLeft:-50"/>
										</div>
									</th>
							</tr>
						</table>
						...
						<a href="sem3_fia.php"><input id="inputsubmit1" type="button" name="inputsubmit1" value="   Back   " /></a>		
					</form>
