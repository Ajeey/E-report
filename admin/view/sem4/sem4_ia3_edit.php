		...
		<div id="welcome" class="post">
			...
			<div id="login" align="center" class="story">
					<form id="sem4_ia3" class="formular" method="post" action="sem4_ia3_process.php">
						...
						<table border="1" bordercolor="#4c84f7" width="80%" cellspacing="2" cellpadding="3">
							...
							<tr>
									...
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca41_ia3" id="10mca41_ia3" class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $a1?>"/>
										</div>
									</th>
									<th width="364" scope="col">
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca42_ia3" id="10mca42_ia3" class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $a2?>"/>
									</div>
									</th>
									<th width="364" scope="col">
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca43_ia3" id="10mca43_ia3" class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $a3?>"/>
									</div>
									</th>
									<th width="364" scope="col">
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca44_ia3" id="10mca44_ia3" class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $a4?>"/>
									</div>
									</th>
									<th width="364" scope="col">
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca451_ia3" id="10mca451_ia3" value="<?php echo $a5?>"/>
									</div>
									</th>
									<th width="364" scope="col">
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca452_ia3" id="10mca452_ia3"  value="<?php echo $a6?>"/>
									</div>
									</th>
									<th width="364" scope="col">
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca453_ia3" id="10mca453_ia3"  value="<?php echo $a7?>"/>
									</div>
									</th>
									<th width="364" scope="col">
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca454_ia3" id="10mca454_ia3"  value="<?php echo $a8?>"/>
									</div>
									</th>
									<th width="364" scope="col">
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca455_ia3" id="10mca455_ia3"  value="<?php echo $a9?>"/>
									</div>
									</th>
									<th width="364" scope="col">
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca456_ia3" id="10mca456_ia3"  value="<?php echo $a10?>"/>
									</div>
									</th>
									<th width="364" scope="col">
						...
						<a href="sem4_ia3.php"><input id="inputsubmit1" type="button" name="inputsubmit1" value="   Back   " /></a>
