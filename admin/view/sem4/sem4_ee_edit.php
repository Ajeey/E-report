		...
		<div id="welcome" class="post">
			...
			<div id="login" align="center" class="story">
					<form id="sem4_ee" class="formular" method="post" action="sem4_ee_process.php">
						...
						<table border="1" bordercolor="#4c84f7" width="80%" cellspacing="2" cellpadding="3">
							...
							<tr>
									...
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca41_ee" id="10mca41_ee" class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $a1?>"/>
										</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca41_pf" id="10mca41_pf" class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $p1?>"/>
										</div>
									</th>
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca42_ee" id="10mca42_ee" class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $a2?>"/>
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca42_pf" id="10mca42_pf" class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $p2?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca43_ee" id="10mca43_ee" class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $a3?>"/>
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca43_pf" id="10mca43_pf" class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $p3?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca44_ee" id="10mca44_ee"class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $a4?>"/>
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca44_pf" id="10mca44_pf"class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $p4?>"/>
										</div>
									</th>
							</tr>
							<tr>
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca451_ee" id="10mca451_ee" value="<?php echo $a5?>"/>
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca451_pf" id="10mca451_pf" value="<?php echo $p5?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca452_ee" id="10mca452_ee" value="<?php echo $a6?>"/>
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca452_pf" id="10mca452_pf" value="<?php echo $p6?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca453_ee" id="10mca453_ee" value="<?php echo $a7?>"/>
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca453_pf" id="10mca453_pf" value="<?php echo $p7?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca454_ee" id="10mca454_ee" value="<?php echo $a8?>"/>
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca454_pf" id="10mca454_pf" value="<?php echo $p8?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca455_ee" id="10mca455_ee" value="<?php echo $a9?>"/>
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca455_pf" id="10mca455_pf" value="<?php echo $p9?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca456_ee" id="10mca456_ee" value="<?php echo $a10?>"/>
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca456_pf" id="10mca456_pf" value="<?php echo $p10?>"/>
										</div>
									</th>
							</tr>
							<tr>
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca46_ee" id="10mca46_ee"class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $a11?>"/>
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca46_pf" id="10mca46_pf"class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $p11?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca47_ee" id="10mca47_ee"class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $a12?>"/>
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca47_pf" id="10mca47_pf"class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $p12?>"/>
										</div>
									</th>
							</tr>
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca48_ee" id="10mca48_ee"class="validate[required] text-input" data-prompt-position="topLeft:-50"value="<?php echo $a13?>"/>
									</div>
									</th>
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca48_pf" id="10mca48_pf"class="validate[required] text-input" data-prompt-position="topLeft:-50" value="<?php echo $p13?>"/>
										</div>
									</th>
							</tr>
						</table>
						...
						<a href="sem4_ee.php"><input id="inputsubmit1" type="button" name="inputsubmit1" value="   Back   " /></a>	
					</form>
