						...
						<table border="1" bordercolor="#4c84f7" width="80%" cellspacing="2" cellpadding="3">
							...
							<tr>
									...
									<th width="364" scope="col">
										<div align="center"><input type="text" size="5" name="10mca31_ia1" id="10mca31_ia1" class="validate[required] text-input" data-prompt-position="topLeft:-50"/>
										</div>
									</th>
									<th width="364" scope="col">
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca32_ia1" id="10mca32_ia1" class="validate[required] text-input" data-prompt-position="topLeft:-50"/>
									</div>
									</th>
									<th width="364" scope="col">
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca33_ia1" id="10mca33_ia1" class="validate[required] text-input" data-prompt-position="topLeft:-50"/>
									</div>
									</th>
									<th width="364" scope="col">
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca34_ia1" id="10mca34_ia1" class="validate[required] text-input" data-prompt-position="topLeft:-50"/>
									</div>
									</th>
									<th width="364" scope="col">
							...
							<tr>
									...
									<th scope="col">
										<div align="center"><input type="text" size="5" name="10mca35_ia1" id="10mca35_ia1" class="validate[required] text-input" data-prompt-position="topLeft:-50"/>
									</div>
									</th>
									<th width="364" scope="col">
