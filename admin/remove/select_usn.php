...
<div id="header">
	...
	<div id="menu">
		<ul>
			...
			<li><a href="../view/select_usn.php">View</a></li>
...
<div id="content">
	...
	<div id="main">
		<div id="welcome" class="post">
			...
			<form name="" action="remove_process.php" method="post">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input id="inputsubmit1" type="submit" name="inputsubmit1" value="Remove"/>&nbsp;&nbsp;&nbsp;
			</form>
			</div>
		</div>
