...
<div id="header">
	...
	<div id="menu">
		<ul>
			...
			<li class="active"><a href="#" title="">Admin Login</a></li>
		...
		<div id="login" class="boxed">
			...
			<div class="content">
				<form id="form1" method="post" action="adminlogin.php">
					<fieldset>
					<legend>Sign-In</legend> <!-- for grouping related elements-->
					<label for="inputtext1">Username:</label> <!-- defines caption for fieldset-->
					<input id="inputtext1" type="text" name="inputtext1" value="Enter Username Here" onFocus="clearFieldFirstTime(this);" />
