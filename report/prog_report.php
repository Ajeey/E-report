	...
	<div id="main3">
		<div id="welcome" class="post">
			...
			<table>
				<tr>
					...
					<th><div align="center"><input type="text" size="25" name="10mca31_ia1" id="10mca31_ia1"/></th></div>
					<td>USN:</td>
					<th><div align="center"><input type="text" size="10" name="10mca31_ia1" id="10mca31_ia1"/></th></div>
				</tr>	
			</table></br>
			<p>
		...
		<table border="1" bordercolor="#4c84f7" width="80%" cellspacing="2" cellpadding="3">
			...
			<tr>
				...
				<th width="364" scope="col">
					<div align="center"><input type="text" size="15" name="10mca21_ia2" id="10mca21_ia2"/>
					</div>
				</th>
				<th width="364" scope="col">
